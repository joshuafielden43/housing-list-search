...
from housing_list_search.url_policy import URLPolicyError, is_safe_http_url, validate_http_url


class TestValidateHttpUrl:
    def test_allows_public_https_url(self):
        with patch("housing_list_search.url_policy._check_resolved_addresses"):
    ...
    def test_rejects_dns_to_private_ip(self):
        with patch(
            "housing_list_search.url_policy.socket.getaddrinfo",
