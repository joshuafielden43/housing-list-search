"""
inventory_store.py — Inventory Store deep module (#1072).

Run-path SQLite: upsert, identity confirm touches, machine CSV export, run_history
for full-run baseline. Destructive operator ops live in operator_maintenance.py.

Public type for Machine Persist / Staff Publish / tests: InventoryStore.
DatabaseManager in db.py remains a thin facade that also exposes maintenance.
"""
...
class InventoryStore:
    """SQLite inventory for housing_records on the Run path."""
